export default {
    ...
    help: {
        ...
        close: 'Close help',
        title: 'How to use',
        intro: 'You can generate a block, adjust it to your preferred appearance, and save it as an image.',
        step1Title: 'Set generation conditions',
        step1Body: 'Set the generation count, size, density, and other conditions, then select Start.',
        step2Title: 'Browse blocks',
        step2Body: 'Use the arrow buttons to view the generated blocks one at a time.',
        step3Title: 'Adjust the view',
        step3Body: 'In the Rendering tab, adjust the colors, camera, and lighting. Drag the block image to rotate it, and scroll to zoom in or out.',
        step4Title: 'Save as JPG',
        step4Body: 'To save the block image, select the JPG button.',
